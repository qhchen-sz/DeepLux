        ...
        public async void Connect()
        {
            ...
            if (IsConnected == true)
                ...
                case eCommunicationType.XinJETcpNet:
                    ...
                    if (xinJE == null)
                    {
                        xinJE = new XinJETcpNet(XinJESeries.XC, RemoteIP);
                        xinJE.AddressStartWithZero = false;
                    ...
                    OperateResult connect3 = xinJE.ConnectServer();
        ...
        public bool WriteRegister(string address, PLCDataWriteReadTypeEnum type, string data)
        {
            ...
            switch (CommunicationType)
            {
                ...
                case eCommunicationType.Mc:
                    ...
                    break;
                case eCommunicationType.XinJETcpNet:
                    readWriteNet = xinJE as HslCommunication.Core.IReadWriteNet;
                    //m_modbusRtuClient.DataFormat = (HslCommunication.Core.DataFormat)m_PLCDataType; //HslCommunication.Core.DataFormat.CDAB;
                    switch (type)
                    {
                        case PLCDataWriteReadTypeEnum.布尔:
