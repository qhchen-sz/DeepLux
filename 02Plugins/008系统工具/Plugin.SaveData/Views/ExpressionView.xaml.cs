...
namespace Plugin.SaveData.Views
{
    ...
    public partial class ExpressionView : MetroWindow
    {
        ...
        private void dg_PreviewMouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            switch (selectedRow.DataType)
            {
                ...
                case "int":
                    ...
                    break;
                case "HImage":
                    tempStr = "GetImage(\"" + "&" + selectModel.DisplayName + "." + selectedRow.Name + "\")";
                    break;
                case "Image[]":
                    tempStr = "GetImage[](\"" + "&" + selectModel.DisplayName + "." + selectedRow.Name + "\")";
                    break;
                case "int[]":
                    tempStr = "GetListInt(\"" + "&" + selectModel.DisplayName + "." + selectedRow.Name + "\")";
                    break;
                case "double[]":
                    tempStr = "GetListDouble(\"" + "&" + selectModel.DisplayName + "." + selectedRow.Name + "\")";
                    break;
                case "bool[]":
                    tempStr = "GetListBool(\"" + "&" + selectModel.DisplayName + "." + selectedRow.Name + "\")";
                    break;
                case "string[]":
                    tempStr = "GetListString(\"" + "&" + selectModel.DisplayName + "." + selectedRow.Name + "\")";
                    break;
                default:
                    break;
            }
        ...
        //    {
        //        Var.IsCompileSuccess = true;
        //        bool b = (bool)Var.m_TempScriptSupport.CodeRun();
        //        if (type==1)
        //        {
        //            this.Close();
        //            return;
