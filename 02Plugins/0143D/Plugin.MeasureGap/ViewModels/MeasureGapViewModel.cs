...
namespace Plugin.MeasureGap.ViewModels
{
    #region enum
    ...
    [Category("3D")]
    [DisplayName("测量缝隙")]
    [ModuleImageName("MeasureGap")]
    [Serializable]
    public class MeasureGapViewModel : ModuleBase
    {
        ...
        public override void AddOutputParams()
        {
            ...
            AddOutputParam("缝隙宽度", "double", GapValue);
        ...
        public CommandBase ConfirmCommand
        {
            get
            {
                if (_ConfirmCommand == null)
                {
                    ...
                    {
                        var view = this.ModuleView as MeasureGapView;
                        if (view != null)
                        {
                            view.Close();
                        }
        ...
        public override void HVDeserialize(string json)
        {
...

            {
                  ...
                  Logger.AddLog($"MeasureGapViewModel.HVDeserialize 异常: {ex.Message}", eMsgType.Error);
